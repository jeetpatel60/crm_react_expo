...
import { updatePaymentRequestTemplate } from '../database';
import { spacing, shadows } from '../constants/theme';

type EditPaymentRequestTemplateRouteProp = RouteProp<RootStackParamList, 'EditPaymentRequestTemplate'>;
type EditPaymentRequestTemplateNavigationProp = StackNavigationProp<RootStackParamList>;

const EditPaymentRequestTemplateScreen: React.FC = () => {
  const route = useRoute<EditPaymentRequestTemplateRouteProp>();
  ...
  const navigation = useNavigation<EditPaymentRequestTemplateNavigationProp>();
  ...
  const handleSubmit = async () => {
    ...
    try {
      setSubmitting(true);
      await updatePaymentRequestTemplate({
        id: template.id,
        name: name.trim(),
      ...
      console.error('Error updating payment request template:', error);
...
export default EditPaymentRequestTemplateScreen;
